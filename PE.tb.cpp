...
int main() {
    ...
    score += test_it("trace/PE/02-half.vcd", Data::new_with(&Data::init_half, num_el));
    score += test_it("trace/PE/03-eye.vcd", Data::new_with(&Data::init_eye, num_el));
    score += test_it("trace/PE/04-empty.vcd", Data::new_with(&Data::init_empty, num_el));
    score += test_it("trace/PE/05-linesep.vcd", Data::new_with(&Data::init_linesep, num_el));
    int Q0 = 0, Q1 = num_el / 4, Q2 = num_el / 2, Q3 = num_el * 3 / 4, Q4 = num_el;
    score += test_it("trace/PE/06-rand-Q1.vcd", Data::new_with(&Data::init_rand, num_el, Range{Q0, Q1}));
    score += test_it("trace/PE/07-rand-Q2.vcd", Data::new_with(&Data::init_rand, num_el, Range{Q1, Q2}));
    score += test_it("trace/PE/08-rand-Q3.vcd", Data::new_with(&Data::init_rand, num_el, Range{Q2, Q3}));
    score += test_it("trace/PE/09-rand-Q4.vcd", Data::new_with(&Data::init_rand, num_el, Range{Q3, Q4}));
    score += test_it("trace/PE/10-rand-H1.vcd", Data::new_with(&Data::init_rand, num_el, Range{Q0, Q2}));
    score += test_it("trace/PE/11-rand-H2.vcd", Data::new_with(&Data::init_rand, num_el, Range{Q1, Q3}));
    score += test_it("trace/PE/12-rand-H3.vcd", Data::new_with(&Data::init_rand, num_el, Range{Q2, Q4}));
    score += test_it("trace/PE/13-rand.vcd", Data::new_with(&Data::init_rand, num_el, Range{Q0, Q4}));
